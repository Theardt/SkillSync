...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  Widget build(BuildContext context) {
    //retrieve signed in users display name - if null, default = learner
              ...
              child: currentUser == null
                  ...
                  : StreamBuilder<DocumentSnapshot>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        int xpLevelUpRemaining = levelData.xpRemaining;
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "$xpLevelUpRemaining XP until Level ${level + 1}",
                                      style: TextStyle(
                                        color: Colors.white70,
                                        fontSize: 14,
                                      ),
                              ...
                              buildCourseCard(
                                ...
                                subtitle: "Learn networking and cyber defense",
                                progress: 0.45,
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        padding: EdgeInsets.all(
          MediaQuery.of(context).size.width < 700 ? 16 : 20,
        ),
        decoration: BoxDecoration(
          color: AppColors.card,
          borderRadius: BorderRadius.circular(18),
